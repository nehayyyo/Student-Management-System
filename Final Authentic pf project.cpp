...
// Structures for different entities
struct Student {
    int id;
    string name;
    int age;
...
// Global arrays to hold data and their respective sizes
Student students[50];  // Array to store up to 50 students
Teacher teachers[50];  // Array to store up to 50 teachers
ClassSchedule schedules[50];  // Array to store up to 50 class schedules
FeeRecord fees[50];  // Array to store up to 50 fee records
...
//Part3 Class Schedule Management-----------------------------------------------------------------------
